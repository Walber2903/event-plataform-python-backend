...
class AttendeesHandler:
  ...
  def register(self, http_request: HttpRequest) -> HttpResponse:
    ...
    ): raise HttpConflictError("Event is fully booked!") 
  ...
  def find_attendee_badge(self, http_request: HttpRequest) -> HttpResponse:
    ...
    if not badge: raise HttpNotFound("Participant not found!")
  ...
  def find_attendees_from_event(self, http_request: HttpRequest) -> HttpResponse:
    ...
    if not attendees: raise HttpNotFound("Participants not found!")
